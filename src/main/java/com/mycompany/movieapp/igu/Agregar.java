...
public class Agregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuardar.setBackground(new java.awt.Color(34, 103, 173));
        ...
        background.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 390, 140, 40));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.guardar(titulo,director,anio,duracion,genero);
        
        mostrarMensaje("Película guardada exitosamente!","info","Guardar");
